...
define(["jquery", "gl-matrix", "util", 
    ...
    $(document).ready( (function() {
        ...
        // register the showColorAndLineWidth function in the onSelection function to be triggered on object selection
        sceneController.onSelection(htmlController.showColorAndLineWidth);

        // register the showColorAndLineWidth function in the onObjChange function to be triggered on object change
        sceneController.onObjChange(htmlController.showColorAndLineWidth);
